...
**Progress:** 🟢 Easy: **10** | 🟡 Medium: **1** | 🔴 Hard: **0** | 📌 Total: **11**
...
| 1342 | [Number of Steps to Reduce a Number to Zero](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/) | Math, Bit Manipulation, Simulation | Easy | O(log n) | O(1) | [C++](./1342_Number_of_Steps_to_Reduce_a_Number_to_Zero.cpp) |
