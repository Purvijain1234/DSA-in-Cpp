...
- Carry handling is a common technique in arithmetic problems.
- Traverse linked lists of different lengths safely.
- Continue processing while carry exists, even after both lists end.
